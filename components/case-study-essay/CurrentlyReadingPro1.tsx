...
/**
 * Pro 1 Painters variant of CurrentlyReading.
 *
 * The shared CurrentlyReading hardcodes the project label "Air Solutions" in
 * the corner indicator, so it cannot be reused verbatim on another case study.
 * This variant is identical in behavior but labelled for Pro 1 Painters. The
 * shared component is left untouched (other agents rely on it unchanged).
 */
...
export default function CurrentlyReadingPro1() {
  ...
  return (
    ...
    >
      <span className={styles.project}>Pro 1 Painters</span>
