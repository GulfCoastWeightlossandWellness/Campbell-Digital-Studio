...
export const metadata: Metadata = {
  ...
  description:
    "A 210-page programmatic SEO platform for an HVAC contractor in Baldwin County, Alabama — 21 cities × 10 services, Three.js diagnostic tool, NWS hurricane alert integration, 9-type Schema.org architecture.",
  alternates: { canonical: "/work/air-solutions" },
  openGraph: {
    title: "Air Solutions Heating & Cooling | Campbell Digital Studio",
    description:
      "210 programmatic pages. 4 custom interactive tools. 9 Schema.org types. The strongest technical local-search platform in Baldwin County HVAC.",
    url: "/work/air-solutions",
    images: [{ url: "/images/case-studies/covers/air-solutions-1-hero.jpg" }],
  },
};
