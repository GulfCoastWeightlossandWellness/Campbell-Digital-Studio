...
export const projects: Project[] = [
  ...
  // ── ACExperts251 ─────────────────────────────────────────────────────────
  {
    ...
    shortName: "ACExperts",
    label: "Original Build",
    category: "HVAC · Programmatic Local SEO",
    tier: 1,
    industry: "Local Services",
    status: "Active Retainer",
    year: "2026",
    ...
    filterTags: ["full-stack", "local", "platform"],
    valueExplainer:
      "ACExperts is the clearest proof a CDS build pays for itself. A brand-new HVAC business on a brand-new domain went live 4/22/2026 with no search history, no reviews, and no rankings. Seven weeks later it had 215 pages indexed, ~44,800 Google impressions, and ranked in the local map pack across six Baldwin County cities — against incumbents with 25 to 40 years and hundreds of reviews. In that seventh week, a single website form lead became an $8,500 install. Everything here was built from zero in under two months.",
    shortSummary:
      "Took a brand-new HVAC business from zero to 215 indexed pages, ~44,800 Google impressions, and an $8,500 form lead in seven weeks.",
    summary:
      "ACExperts251 launched 4/22/2026 as a brand-new HVAC business — new domain, no history. The build is a 274-page Next.js platform now live at acexperts251.com: a programmatic city × service matrix across 17 Baldwin County cities, dedicated service hubs, a native blog engine, interactive diagnostic tools, and Resend-powered lead forms that email the owner directly. Seven weeks in, it had 215 pages indexed, ~44,800 Google impressions, local-pack rankings in six cities, and a website lead that converted to an $8,500 install.",
    liveUrl: "https://www.acexperts251.com/",
    tags: ["HVAC", "Programmatic SEO", "Local SEO", "Next.js"],
    features: [
      "274 live pages — verified on the live sitemap, 2026-06-13",
      "Programmatic city × service matrix across 17 Baldwin County cities — 171 service-area pages, each individually routed and indexed",
      "Dedicated service hubs — AC repair, installation, maintenance, heating, heat pump, mini-split, commercial, and emergency",
      "Native blog engine — 62+ posts compounding topical authority",
      "Interactive diagnostic tools — a Three.js 3D AC explorer, a symptom-to-repair quiz, and an HVAC ROI calculator no county competitor offers",
      "Resend-powered lead forms — submissions email the owner directly for fast response",
      "Dedicated emergency-service and maintenance-plan pages",
      "CDS-managed Google Business Profile — the local-pack engine running alongside the site",
    ],
    valuePoints: [
      "215 pages indexed and ~44,800 Google impressions in the first seven weeks — from a domain that did not exist before 4/22",
      "Ranks in the local map pack in six Baldwin County cities — #1 in four — against 25-to-40-year incumbents",
      "A website form lead converted to an $8,500 install, helping the business reach ~$30k in revenue by week seven",
      "Programmatic city × service matrix makes a brand-new business findable across the whole county, not just its home city",
      "Website and Google Business Profile run as one system — 78 GBP customer actions on top of organic search",
    ],
    stack: "Next.js, TypeScript, Tailwind, Vercel, Three.js / WebGL (3D AC explorer), Resend (lead forms), programmatic city × service matrix, native blog engine",
    hosting: "Vercel",
    launched: "2026-04",
    challenge:
      "ACExperts started from nothing — a brand-new HVAC business on a brand-new domain, with no search history, no reviews, and no rankings. Baldwin County HVAC is owned by names with 25 to 40 years of trust and hundreds of reviews. The site had to make a brand-new company findable and credible fast enough to compete before it had any of that, and turn that visibility into booked work rather than just traffic.",
    whatIBuilt:
      "A 274-page Next.js platform now live at acexperts251.com — a programmatic city × service matrix across 17 Baldwin County cities (171 service-area pages), dedicated service hubs, a native blog engine, three interactive diagnostic tools (a Three.js 3D AC explorer, a symptom-to-repair quiz, and an HVAC ROI calculator), Resend-powered lead forms that email the owner directly, and a CDS-managed Google Business Profile operation running alongside the site as the local-pack engine.",
    seoConversion:
      "Every city × service intersection is a standalone indexed page with unique local content, metadata, schema, and internal links — 274 live pages on the sitemap. From the 4/22 launch, the platform reached 215 indexed pages (~78%, only 7 quality-rejected) and ~44,800 Google impressions in seven weeks, with weekly impressions climbing from near-zero to ~15,500. It ranks in the local map pack across six cities — #1 in Robertsdale, Lillian, Stockton, and Rosinton — and the native blog engine compounds authority at a cadence the county's incumbents do not match.",
    businessValue:
      "Took a brand-new HVAC business from invisible to booking real work in under two months. Beyond the build: 215 indexed pages, ~44,800 impressions, local-pack rankings in six cities, and 304 Google Business Profile views driving 78 customer actions — calls, directions, and clicks. In week seven, a website form lead became an $8,500 install, helping the business reach ~$30k in revenue. The site and the GBP run as one system: the organic click count alone understates the result, because the lead engine is the two working together.",
    screenshotLabels: [
    ...
    metaGrid: [
      { label: "Sector", value: "HVAC · Local Services" },
      { label: "Live", value: "Apr 2026 · new business" },
      { label: "Indexed", value: "215 pages · 44.8K impr" },
      { label: "Engagement", value: "Active Retainer" },
    ],
  },
