...
export const projects: Project[] = [
  ...
  // ── Gulf Coast Weight & Wellness ──────────────────────────────────────────
  {
    ...
    filterTags: ["medical", "full-stack"],
    pricingTier: "senior-dev",
    pricing: {
      agency: "$25,000 – $45,000",
      highFreelance: "$8,000 – $18,000",
      lowFreelance: "$2,000 – $4,000",
    },
    pricingNotes: {
      agency: "A medical web agency building a complete telehealth clinic platform with 5 service verticals, provider profiles, and a transparent pricing architecture would scope this at $25K minimum — usually closer to $40K with copywriting.",
      highFreelance: "A freelancer who understands telehealth clinic positioning, medical disclaimer requirements, hormone therapy service architecture, and conversion-focused copy for a cash-pay medical audience is not a generalist hire.",
      lowFreelance: "A generalist builds a homepage and a contact page. No individual service pages for each treatment category, no pricing transparency section, no provider profiles structured for clinical credibility, no disclaimers calibrated for medical compliance.",
    },
    valueExplainer: "Telehealth weight loss and hormone clinics face a trust problem — patients can't distinguish legitimate medical practices from supplement marketing. A site with individual service pages for each treatment, transparent pricing, and provider profiles signals clinical legitimacy in the first 10 seconds. This is an early build that established the service-page architecture patterns now used across the medical wellness category.",
    shortSummary:
