...
export const projects: Project[] = [
  // ── Air Solutions Heating & Cooling ───────────────────────────────────────
  {
    ...
    shortSummary:
      "Shipped 210 programmatic SEO pages across 21 cities × 10 services for a coastal-Alabama HVAC contractor. Four custom interactive tools.",
    summary:
      "Air Solutions Heating & Cooling commissioned a build replacing a 36-page WordPress brochure with a programmatic SEO platform: a 21 cities × 10 services matrix, a 9-type Schema.org architecture, four custom interactive tools, and a native automated publishing engine. The same architectural pattern Netflix and Vercel use for production applications, applied to a local HVAC contractor in Baldwin County, Alabama.",
    liveUrl: "https://air-solutions-pros.vercel.app",
    tags: ["HVAC", "Programmatic SEO", "Custom Tools", "Next.js"],
    features: [
      "210 cross-pages + service hubs at launch — full 21×10 matrix, ~6× the old WordPress site",
      "Programmatic SEO matrix: 21 Baldwin County cities × 10 HVAC services",
      "10 service hub pages — AC repair, AC installation, AC maintenance, heating repair, heating installation, heat pump, mini-split, IAQ, commercial, emergency",
      "21 city hub pages — Daphne, Fairhope, Foley, Gulf Shores, Orange Beach, and 16 more across Baldwin County",
    ...
    valuePoints: [
      ...
      "GBP operations retainer running monthly with API automation pipeline once approved",
    ],
    stack:
    ...
    screenshotLabels: [
      ...
      "City coverage — 21 Baldwin County cities",
    ...
    screenshots: [
      ...
      { src: "/images/case-studies/covers/air-solutions-5-cities.png", label: "City coverage — 21 Baldwin County cities" },
      { src: "/images/case-studies/covers/air-solutions-6-cool-club.png", label: "Cool Club — maintenance program landing" },
      { src: "/images/case-studies/covers/air-solutions-7-schedule.png", label: "Schedule HVAC service — typed form pipeline" },
      { src: "/images/case-studies/covers/air-solutions-8-3d-explorer.png", label: "3D AC Explorer — interactive Three.js model" },
      { src: "/images/case-studies/covers/air-solutions-9-field-guide.png", label: "Field Guide — automated content engine" },
      { src: "/images/case-studies/covers/air-solutions-10-guides.png", label: "Cost guides and decision tools" },
      { src: "/images/case-studies/covers/air-solutions-11-coverage.png", label: "Service-area coverage map" },
      { src: "/images/case-studies/covers/air-solutions-12-reviews.png", label: "Live Google Reviews integration" },
    ],
    metaGrid: [
      { label: "Sector", value: "HVAC · Local Services" },
      { label: "Stack", value: "Next.js 14 + Vercel" },
      { label: "Engagement", value: "Active Retainer" },
      { label: "Shipped", value: "May 2026" },
    ],
  },
  ...
  // ── Blessed Barbershop ───────────────────────────────────────────────────
  {
    ...
    screenshots: [
      ...
      { src: "/images/case-studies/covers/blessed-4-reviews.png", label: "Reviews and social proof" },
